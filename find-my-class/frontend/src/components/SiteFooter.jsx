...
export default function SiteFooter() {
  return (
    <footer id="contact-footer" className="relative border-t border-gray-200/80 bg-white">
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-gray-600">
              <li>
                <a href="#about-section" className="transition-colors hover:text-brand-600">
                  How it works
                </a>
              </li>
              <li>
                <a href="#jobs-section" className="transition-colors hover:text-brand-600">
                  Featured spaces
                </a>
              </li>
              <li>
                <Link to="/map" className="transition-colors hover:text-brand-600">
                  Indoor routes
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wide text-gray-900">Stay in touch</h3>
            <p className="mt-4 text-sm text-gray-600">Newsletter (demo — no backend)</p>
            <form
            ...
            >
              ...
              <input
                ...
                className="min-w-0 flex-1 rounded-full border border-gray-200 bg-gray-50/80 px-4 py-2.5 text-sm text-gray-900 outline-none ring-brand-500/30 transition-all focus:border-brand-500 focus:bg-white focus:ring-4"
              />
              <motion.button
                type="submit"
            ...
            <div className="mt-6 flex gap-3">
              {social.map(({ icon: Icon, href, label }) => (
                <motion.a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-500 shadow-sm transition hover:border-brand-200 hover:text-brand-600"
                >
